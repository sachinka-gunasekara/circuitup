  ...
  return (
    ...
    <div className="relative h-[65vh]">
        <div className="flex flex-col justify-between items-center gap-20 sm:flex-row">
          ...
          <div className='flex justify-center w-full font-extrabold text-5xl pt-40 pb-20 text-slate-200 sm:text-7xl sm:pt-56 sm:pb-36 tracking-widest'  data-aos="zoom-in">PCB Designs</div>   
